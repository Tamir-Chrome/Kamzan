...
export default class EditValuePrompt extends Component {
  ...
  onSubmit() {
    ...
    const { price, name, actName } = this.state;
    this.setModalVisible(false);
    parentScreen.submitInput(price, name, actName);
  }

  setModalVisible(visible, actName = '') {
    this.setState({ modalVisible: visible, actName });
  }
